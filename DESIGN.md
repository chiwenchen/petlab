...
Three semantic layers, **no decorative colors**.
...
| `accent`     | `#111827` | Primary CTA bg, focus ring                         |
...
System font stack — **but only as base**. No display typography needed for v1.

- Headings: `font-semibold` (600), tighter line-height
- Body: `font-normal` (400), 14-16px
- Numbers: `tabular-nums` always for value columns
- Medical abbreviations: `font-mono` (system) is OK for codes; default for names
